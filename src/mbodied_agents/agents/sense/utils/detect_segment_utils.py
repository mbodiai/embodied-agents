...
def annotate(image: Union[Image.Image, np.ndarray], detection_results: List[DetectionResult]) -> np.ndarray:
    ...
    Args:
        image (Union[Image.Image, np.ndarray]): The image to annotate.
...
def plot_detections(
    image: Union[Image.Image, np.ndarray], detections: List[DetectionResult], save_name: str = None
) -> None:
    """
    Plot and save detection results on the image.

    Args:
        image (Union[Image.Image, np.ndarray]): The image to plot detections on.
...
def load_image(image: Union[str, np.ndarray, Image.Image]) -> Image.Image:
    ...
    Args:
        image (Union[str, np.ndarray, Image.Image]): The image to load.
