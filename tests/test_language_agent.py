...
@mock.patch("mbodied_agents.agents.backends.OpenAIBackend.__init__", return_value=None)
@mock.patch("mbodied_agents.agents.backends.OpenAIBackend.act", return_value=mock_openai_response)
