...
def audio_handler(mocker):
    mocker.patch("mbodied_agents.agents.sense.audio.audio_handler.OpenAI")
    mocker.patch("mbodied_agents.agents.sense.audio.audio_handler.pyaudio.PyAudio")
    mock_openai = mocker.patch("mbodied_agents.agents.sense.audio.audio_handler.OpenAI").return_value
...
def test_listen_speak_mode(mocker, audio_handler):
    ...
    mock_thread = mocker.patch("mbodied_agents.agents.sense.audio.audio_handler.threading.Thread")
...
def test_play_audio(mocker, audio_handler):
    mock_playsound = mocker.patch("mbodied_agents.agents.sense.audio.audio_handler.playsound.playsound")
    mocker.patch("mbodied_agents.agents.sense.audio.audio_handler.os.path.exists", return_value=True)
    mock_remove = mocker.patch("mbodied_agents.agents.sense.audio.audio_handler.os.remove")
